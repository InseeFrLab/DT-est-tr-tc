...
saveRDS(all_t, "results_fredm/compile_tp_norev/troughs_rkhs.RDS")
saveRDS(all_p, "results_fredm/compile_tp_norev/peaks_rkhs.RDS")
...
rownames(all_t) <- rownames(all_p) <- full_names
saveRDS(all_t,
        "results_fredm/compile_tp_norev/troughs_fst.RDS")
saveRDS(all_p,
        "results_fredm/compile_tp_norev/peaks_fst.RDS")
